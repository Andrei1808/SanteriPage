        ...
        <div className={s.feedbackItems}>
          <div className={s.feedbackItem}>
            ...
            <p className={s.feedbackText}>
              "Yrityksenne tarjosi erinomaista palvelua, kun tarvitsin apua
              kodin siivouksessa ja korjauksissa. Tiimi oli ammattitaitoinen ja
              ystävällinen, ja he tekivät loistavaa työtä muuttaen tilani
              mukavaksi ja viihtyisäksi. Olen erittäin tyytyväinen
              lopputulokseen ja suosittelen teitä kaikille!"
